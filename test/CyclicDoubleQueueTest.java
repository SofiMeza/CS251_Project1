    ...
    public void test2() {
        ...
        for (int i = 0; i < temp; i++) {
            try {
                ...
                //System.out.println("size is " + queue.getQueueLength());
            } catch (Exception e) {
                fail(e.getMessage());
            }
        }
            ...
            switch (gen.nextInt(4)) {
                case 0:
                    ...
                    try {
                        ...
                        //System.out.println("comparing " + list.get(0) + " and " + queue.peekFront());
                        assertEquals("Error in enqueueFront/peekFront " + queue.getSize(), list.get(0), queue.peekFront());
                ...
                case 1:
                    ...
                    if (queue.getSize() > 0) {
                        try {
                            ...
                            //System.out.println("comparing " + list.get(0) + " and " + queue.peekFront());
                            assertEquals("Error in dequeueFront/peekFront " + queue.getSize(), list.get(0), queue.peekFront());
                            //System.out.println("size is " + queue.getSize());
                            list.remove(0);
                            queue.dequeueFront();
                        } catch (Exception e) {
                ...
                case 2:
                    ...
                    try {
                        ...
                        //System.out.println("comparing " + list.get(list.size() - 1) + " and " + queue.peekBack());
                        assertEquals("Error in enqueueBack/PeekBack "+ queue.getSize(), list.get(list.size() - 1), queue.peekBack());
                        //System.out.println("size is " + queue.getSize());
                    } catch (Exception e) {
                        fail(e.getMessage());
                    }
                ...
                case 3:
                    ...
                    if (queue.getSize() > 0) {
                        try {
                            ...
                            //System.out.println("comparing " + list.get(list.size() - 1) + " and " + queue.peekBack());
                            assertEquals("Error in dequeueBack/peekBack " + queue.getSize(), list.get(list.size() - 1), queue.peekBack());
